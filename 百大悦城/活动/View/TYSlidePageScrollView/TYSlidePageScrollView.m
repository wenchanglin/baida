...
- (void)addHorScrollView
{
    ...
    scrollView.showsHorizontalScrollIndicator=NO;//默认显示横向滑动条
...
//    WCLLog(@"点击出现的效果%d",index);
    [[NSNotificationCenter defaultCenter]postNotificationName:@"clickBtn" object:nil userInfo:@{@"clickindex":@(index)}];
